...
ー料金について自然に触れる。「診断レポート（¥480）」「攻略レポート（¥980）」「個別戦略書（¥1,980）」の3つのプランがあることを仙人口調で紹介する。「まずは¥480から自分を知るもよし、本気で動くなら¥980か¥1,980もあるぞ」という趣旨で、押し付けず選択肢として提示する。仙人修行中のため今はこの価格でやっていること、コーヒー1杯分から始められる旨も添える。
ー最後に、有料版の章を紹介する。
...
文字量：
- 全体で 2000〜2800 文字（短すぎ禁止。繰り返しを省いてコンパクトに）
- 【はじめに】500〜650字
- 【0章】650〜900字（2つのクセをA/B/C/Dの4点セットで書く。各点を圧縮しすぎない）
- 【1】500〜650字
- 【有料版で分かること】300〜400字
